...
| `{{ fdb_release }}` | Full release version | `7.1.67`, `7.3.77`, `7.4.6` |
| `{{ api_version }}` | API version number | `710`, `730`, `740` |
| `{{ docker_tag }}` | Docker image tag | `7.1.67`, `7.3.77`, `7.4.6` |
| `{{ docker_image }}` | Full Docker image | `foundationdb/foundationdb:7.3.77` |
| `{{ java_version }}` | Java artifact version | `7.1.67`, `7.3.77`, `7.4.6` |
| `{{ package_version }}` | Package version | `7.1.67`, `7.3.77`, `7.4.6` |
