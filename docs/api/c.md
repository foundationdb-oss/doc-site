...
=== "Linux (RHEL/CentOS)"
    ...
    ```bash
    wget https://github.com/apple/foundationdb/releases/download/7.3.77/foundationdb-clients-7.3.77-1.el7.x86_64.rpm
    sudo rpm -i foundationdb-clients-7.3.77-1.el7.x86_64.rpm
    ```
