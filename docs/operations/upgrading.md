...
Patch version downgrades (e.g., 7.3.77 → 7.3.60) may be possible:
...
| **Avoid duplicate protocol versions** | Patch releases (e.g., 7.3.70, 7.3.77) are protocol-compatible; include only the latest |
...
| Patch upgrade (e.g., 7.3.60 → 7.3.77) | Optional | Direct upgrade usually sufficient |
...
# 10.0.4.2:4500  (7.3.77)  coordinator, log, storage  # Upgraded
